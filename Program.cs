...
namespace ConsoleApp
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // ----- NULLABLE TYPES -----
            // Data types by default cannot have a value of null. Often null is needed when you are working with databases and you can create a null type by adding a ? to the definition
            int? randNum = null;
            if (randNum == null)
            {
            ...
            if (!randNum.HasValue)
            {
                Console.WriteLine("randNum has no value");
            }
