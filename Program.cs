...
namespace ConsoleApp
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // We can store our shapes in a Shape array as long as it contains subclasses of Shape
            ...
            foreach (Shape s in shapes)
            {
                ...
                // You can use as to check if an object is of a specific type
                ...
                // You can use is to check the data type
                if (s is Circle)
                {
            ...
            // You can store any class as a base class and call the subclass methods even if they don't exist in the base class by casting
